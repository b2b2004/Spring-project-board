...
class ArticleControllerTest {
    ...
    public void articles() throws Exception {
        ...
        mvc.perform(get("/articles"))
                .andExpect(status().isOk()) // status가 200이니?
    ...
    @DisplayName("view [GET] 게시글 리스트 페이지 - 검색어와 함계 호출")
    @Test
    public void articlesWithSearchKeyword() throws Exception {
        // Given
    ...
    @Test
    void Articlepage_Nothing_returnLoginPage() throws Exception {
        // Given
        long articleId = 1L;
    ...
    @Test
    public void articleNoneSearchHashtag() throws Exception {
        // Given
    ...
    @Test
    void saveArticlePage() throws Exception {
        // Given
    ...
    @WithUserDetails(value = "kwonTest", setupBefore = TestExecutionEvent.TEST_EXECUTION)
    @DisplayName("[view][POST] 새 게시글 등록 - 정상 호출")
    @Test
    void save_newArticle() throws Exception {
        // Given
    ...
    @Test
    void Nothing_returnLoginPage() throws Exception {
        // Given
        long articleId = 1L;
    ...
    @Test
    void updateArticlePage() throws Exception {
        // Given
        long articleId = 1L;
