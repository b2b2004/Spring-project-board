...
class ArticleServiceTest {
    ...
    @Test
    void noSearchParameters_ReturnArticlePage() {
        // Given
    ...
    @Test
    void searchArticleHashtag_ReturnEmptyPage() {
        // Given
        Pageable pageable = Pageable.ofSize(20);
    ...
    @Test
    void searchNonexistentHashtag_ReturnEmptyPage() {
        // Given
    ...
    @DisplayName("해시태그 검색하면, 게시판 페이지를 반환한다.")
    @Test
    void searchArticleHashtag_ReturnArticlesPage() {
        // Given
    ...
    @Test
    void searchArticle_ReturnArticlePage() {
        // Given
    ...
    @Test
    void searchArticleId_returnArticle() {
        // Given
        Long articleId = 1L;
    ...
    @Test
    void searchArticleId_nonethrowError() {
        // Given
        Long articleId = 0L;
    ...
    @Test
    void nonexistentArticleId_ThrowExeption() {
        // Given
        Long articleId = 0L;
        given(articleRepository.findById(articleId)).willReturn(Optional.empty());
    ...
    @Test
    void nonexistentArticleInfo_Log() {
        // Given
    ...
    @Test
    void searchHashTag_returnUniqueHashTagList() {
        // Given
        Article article = createArticle();
